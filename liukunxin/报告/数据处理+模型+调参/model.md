...
![](model_pic/boat_example.png)

数据目标：（保存在csv表格中）

![](model_pic/target_example.png)

这是所得数据的rle编码，解码效果如下：

![](model_pic/rle_decode.png)
...
![](model_pic/bad_image2.png)

![](model_pic/bad_image3.png)
